    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-12 text-stone-800">
      ...
      <section className="bg-white p-6 sm:p-10 rounded-3xl border border-brand-gold/20 shadow-sm space-y-4">
        ...
        <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
          Ella Creations was founded with a singular vision: to democratize royal Indian luxury. We blend centuries-old Kundan and Meenakari metalwork with state-of-the-art gold electroplated finish and AAA+ Cubic Zirconia crystals.
        </p>
        <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
          ...
          <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm space-y-3">
            ...
            <div>
              ...
              <p className="text-stone-500 text-[11px]">Represents handcrafted Kundan foil and gold electroplating.</p>
            </div>
          </div>
