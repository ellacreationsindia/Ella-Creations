...
export default function HomeView() {
  ...
  return (
    <div className="space-y-12 sm:space-y-20 lg:space-y-24 pb-16">
      ...
      {/* Hero Banner Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-brand-sand via-brand-cream to-brand-pink/30 py-10 sm:py-16 lg:py-24 border-b border-brand-gold/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-white/90 backdrop-blur-md px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-brand-gold/40 text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-brand-gold shadow-sm">
                <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-brand-gold" />
              ...
              {/* Gold Divider Motif */}
              <div className="gold-divider max-w-xs mx-auto lg:mx-0 my-3 sm:my-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-1 sm:pt-2">
                <button
                  ...
                  className="w-full sm:w-auto bg-brand-rose hover:bg-brand-rose/90 text-white font-semibold py-3.5 sm:py-4 px-6 sm:px-8 rounded-full shadow-soft-rose transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2 text-xs uppercase tracking-wider min-h-[44px]"
                >
                ...
                <button
                  onClick={() => navigateTo('shop')}
                  className="w-full sm:w-auto bg-white/90 hover:bg-white text-stone-800 font-semibold py-3.5 sm:py-4 px-6 sm:px-8 rounded-full border border-brand-gold/40 hover:border-brand-gold transition-all text-xs uppercase tracking-wider shadow-sm min-h-[44px]"
                >
                  View Bestsellers
                </button>
              </div>
              ...
              {/* Quick Trust Badges */}
              <div className="pt-2 sm:pt-4 grid grid-cols-3 gap-2 sm:gap-6 text-[10px] sm:text-xs text-stone-600 font-medium text-center sm:text-left border-t border-brand-gold/10 sm:border-0">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-xs sm:max-w-sm lg:max-w-none">
                <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl border-2 sm:border-4 border-white bg-gradient-to-b from-stone-50 via-brand-cream/50 to-white p-3 sm:p-4 relative group flex items-center justify-center">
                  <img
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-stone-950/85 via-stone-900/40 to-transparent p-4 sm:p-6 text-white rounded-b-3xl">
                    <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-brand-pink bg-brand-rose/20 px-2.5 py-0.5 sm:py-1 rounded-full border border-brand-pink/30">Signature Piece</span>
                    <h3 className="font-serif text-base sm:text-xl font-bold mt-1 sm:mt-2">Royal Kundan & Pearl Choker</h3>
                  </div>
                </div>

                {/* Floating Emblem Tag */}
                <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-2xl shadow-xl border border-brand-gold/30 items-center gap-2.5 hidden sm:flex">
                  <img src="/logo.png" alt="Logo" className="w-10 h-10 object-contain" />
                  <div>
                    <h4 className="font-serif text-xs font-bold text-stone-900">Ella Creations</h4>
                    <p className="text-[10px] text-brand-rose font-medium">Handcrafted Artificial Jewelry</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-2 sm:space-y-3 mb-6 sm:mb-10">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-stone-900">Shop by Jewelry Category</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
          {[
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-stone-950/85 via-stone-950/25 to-transparent flex flex-col justify-end p-3 sm:p-5 text-white">
                <span className="text-[10px] sm:text-[11px] font-semibold text-brand-pink tracking-wider">{cat.count}</span>
                <h3 className="font-serif text-base sm:text-xl font-bold tracking-wide group-hover:text-brand-pink transition-colors">
                  {cat.title}
                </h3>
              </div>
            </div>
