...
export default function AuthModal({ isOpen, onClose }) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setAuthError('To enable Google Sign-In: Open Supabase Dashboard -> Authentication -> Providers -> Google -> Enable provider & enter Client ID/Secret.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-3xl max-w-md w-full p-6 md:p-8 shadow-2xl border border-brand-gold/30 relative">
        ...
        <div className="text-center space-y-2 mb-6">
          ...
          <p className="text-xs text-stone-500">
            Access your wishlist, order tracking, and VIP perks.
          </p>
        </div>
