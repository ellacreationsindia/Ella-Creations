...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-brand-sand/40 to-stone-900 text-stone-300 pt-16 pb-8 border-t border-brand-gold/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 border-b border-stone-800">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-2">
            ...
            <p className="text-xs text-stone-400">Complimentary priority delivery on all orders exceeding $75.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="Ella Creations Logo" className="h-10 w-auto" />
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-stone-400">
              <li><a href="#" className="hover:text-white transition-colors">Jewelry Care Guide</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Size & Fit Chart</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Shipping & Returns</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Track Order Status</a></li>
              <li><button onClick={() => navigateTo('admin')} className="text-brand-rose font-medium hover:underline">Admin Portal Access</button></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert('Subscribed to VIP Club!'); }} className="flex gap-2">
              <input
                type="email"
